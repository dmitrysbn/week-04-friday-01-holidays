...
us = Cohort.new(Date.new(2018, 01, 22))

puts us
puts us.last_day
# puts us.no_lecture_on(Date.new(2018, 02, 19))
# puts us.class_days
puts us.week_of(Date.new(2018,02,19))
# puts us.coffee_code_day?(Date.new(2018,02,20))
# puts us.coffee_code_week?(Date.new(2018,02,19))
